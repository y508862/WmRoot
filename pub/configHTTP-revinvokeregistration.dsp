...
<tr>
	...
	%else%
        <INPUT TYPE="radio" NAME="ssl" id="ssl" VALUE="false" %ifvar ssl equals('true')%%else%CHECKED%endif% onclick="toggleSSL2(false, document.properties2);"><label for="ssl">HTTP</label>
        <INPUT TYPE="radio" NAME="ssl" id="sslIRTon" VALUE="true"   %ifvar ssl equals('true')%CHECKED%endif%  onclick="toggleSSL2(true, document.properties2);"><label for="sslIRTon">HTTPS</label>
	%endif%
    </td>
</tr>
