/*
 * Copyright ｩ 1996 - 2017 Software AG, Darmstadt, Germany and/or Software AG USA Inc., Reston, VA, USA, and/or its subsidiaries and/or its affiliates and/or their licensors. 
 *
...
function execute(url){
    ...
    if(is_csrf_guard_enabled && needToInsertToken) {
		createForm("htmlform_package_filter_url", url, "POST", "BODY");
		setFormProperty("htmlform_package_filter_url", _csrfTokenNm_, _csrfTokenVal_);
        document.htmlform_package_filter_url.submit();
    } else {
...
function filterPackagesInternal() {
    ...
    for(i=2;i<rowCount;i++){
        ...
        var source= row.cells[0].lastElementChild.value;
