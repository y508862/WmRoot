          ...
          <tr>
              ...
              %else%
                  %ifvar useHSM equals('true')%
						<INPUT TYPE="radio" name="useHSM" id="useHSM1"  VALUE="true" checked><label for="useHSM1">True</label></INPUT>
        	            <INPUT TYPE="radio" name="useHSM" id="useHSM2"  VALUE="false"><label for="useHSM2">False</label></INPUT>
                  %else%
			  			<INPUT TYPE="radio" name="useHSM" id="useHSM1"  VALUE="true" ><label for="useHSM1">True</label></INPUT>
                    	<INPUT TYPE="radio" name="useHSM" id="useHSM2"  VALUE="false" checked><label for="useHSM2">False</label></INPUT>
                %endif%
              %endif%
              </td>
          </tr>
