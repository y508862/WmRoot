...
<TR>
  <TD class="oddrow"><label for="mustUnderstand">Must Understand</label></TD>
  <TD class="oddrow-l">
...
<tr>
  <TD class="evenrow"><label for="soapRoleOptions">Role</label></TD>
  <TD class="evenrow-l">
    %ifvar ../../action equals('view')%
        ...
        <td width="25%">
          <select id="soapRoleOptions" style="width:100%" onchange="toggleSoapRoleInput();">
            ...
            %ifvar ../../action equals('edit')%
              ...
              %endif%
            %endif%
            ><label for="soapRoleInputField">Other</label></option>
          </select>
        </td>
    ...
    <TD class="evenrow-l">
      <table id="responseMapTable" name="responseMapTable" class="tableView" width="100%">
        %ifvar action equals('create')%
          <tr>
			<TD class="oddcol" ><label for="address">Address</label></TD>
			<TD class="oddcol" ><label for="messagingalias">Message Addressing Alias</label></TD>
