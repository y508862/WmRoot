                                ...
                                %ifvar mode equals('edit')%
                  					%invoke wm.server.security.keystore:getKeyStore%
                  						%scope keyStore%
                  							...
                  							selectedPS = "%value keyStoreProvider encode(html)%";
                  						%endscope%
                  					%endinvoke%
                  				%endif%
            ...
            %invoke wm.server.security.keystore:getKeyStore%
              ...
              %ifvar ../type equals('key')%
                 <TR>
                  ...
                  %else%
				  <TR>
                    <TD class="evenrow"><B>Secondary Truststore(optional)</B></TD>
		            <TD class="evenrow-l">%value secondaryTS encode(html)%</TD>
                <TR>
                    <TD class="oddrow" valign="top"><B>Certificate Aliases</B></TD>
                    <TD class="oddrow-l">
                        <TABLE>
        ...
        %else%
            ...
            %ifvar mode matches('edit*')% <!-- Edit keystore/truststore alias block-->
                %ifvar mode equals('edit')% <!-- Edit keystore/truststore alias block-->
                        ...
                        <TR>
				        	<TD class="evenrow"><label for="secondaryTS">Secondary Truststore(optional)</label></TD>
				          	<TD class="evenrow-l">
							<select name="secondaryTS" id="secondaryTS">
								%invoke wm.server.security.keystore:listTrustStores%
                                    <option name="" value=""></option>
                                %loop trustStores%
                                    %ifvar isLoaded equals('true')%
										<option name="%value keyStoreName encode(htmlattr)%" value="%value keyStoreName encode(htmlattr)%" %ifvar keyStoreName vequals(../secondaryTS)%selected%endif%>%value keyStoreName encode(html)%</option>
                                    %endif%
								%endloop%
								%endinvoke%
                            </select>
