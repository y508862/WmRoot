        ...
        <tr>
            <td colspan="2">
                <ul class="listitems">
                    ...
                    <li class="listitem">
                    	<script>getURL("settings-sftp-client-usersettings.dsp", "javascript:document.htmlform_settings_sftp_client_usersettings.submit();", "Return to User Alias Settings")</script>
					</li>
                </ul>
            </td>
        </tr>
