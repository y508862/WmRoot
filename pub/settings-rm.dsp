  ...
  <script language="JavaScript">
    function populateForm(form , seqID ,oper)
    {
        ...
        if('close' == oper) {
            ...
            actionElement = setQueryParamDelim(actionElement) + "operation=rm_close";
        }
        if('terminate' == oper)
        {
            ...
            actionElement = setQueryParamDelim(actionElement) + "operation=rm_terminate";
        }
        if('sendAckReq' == oper)
        {
            ...
            actionElement = setQueryParamDelim(actionElement) + "operation=rm_sendAckReq";
        }
        form.serverSequenceId.value = seqID;
        actionElement = setQueryParamDelim(actionElement) + "serverSequenceId=" + seqID;
