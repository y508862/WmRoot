...
<TR>
  <td class="oddrow"><label for="enable">Enable</label></td>
  <td class="oddrow-l">
...
<TR>
  <TD class="evenrow"><label for="retransmissionInterval">Retransmission Interval</label></TD>
  <TD class="evenrow-l">
    %ifvar ../../action equals('view')%
...
<TR>
  <TD class="oddrow"><label for="maximumRetransmissionCount">Maximum Retransmission Count</label></TD>
  <TD class="oddrow-l">
    %ifvar ../../action equals('view')%
